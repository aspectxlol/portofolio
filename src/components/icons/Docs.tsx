...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function NewFile({ ref, ...svgProps }: SVGProps<SVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-text-fill" viewBox="0 0 16 16" {...svgProps}>
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function OpenFile({ ref, ...svgProps }: SVGProps<SVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-folder-fill" viewBox="0 0 16 16" {...svgProps}>
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function ShareFile({ ref, ...svgProps }: SVGProps<SVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16" {...svgProps}>
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function DownloadFile({ ref, ...svgProps }: SVGProps<SVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cloud-download" viewBox="0 0 16 16" {...svgProps}>
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function PrintFile({ ref, ...svgProps }: SVGProps<SVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-printer-fill" viewBox="0 0 16 16" {...svgProps}>
